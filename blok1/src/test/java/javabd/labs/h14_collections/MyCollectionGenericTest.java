...
class MyCollectionGenericTest {
    ...
    MyCollectionGeneric<String> c;

    @BeforeEach
    void setUp() {
        c = new MyCollectionGeneric<>();
        c.add("1");
        c.add("2");
        c.add("3");
        c.add("4");
    ...
    @Test
    void whenAddIsCalledThenCollectionHasCorrectLengthAndIsNotEmpty() {
        c.add("6");
    ...
    @Test
    void whenRemoveIsCalledThenCollectionHasCorrectLengthAndElementIsRemoved() {
        c.remove("3");
